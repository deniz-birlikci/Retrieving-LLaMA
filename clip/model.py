...
class CLIP(nn.Module):
    ...
    def prep_for_finetuning(self, device):
        self.positional_embedding = nn.Parameter(torch.empty(self.increased_context_length, self.transformer.width, device=device))
    ...
    def positional_interpolation(self):
        ...
        self.positional_embedding = nn.Parameter(new_positional_embedding.type(self.dtype).to(self.positional_embedding.device))
